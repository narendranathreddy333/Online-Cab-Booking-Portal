						...
						<div class="grid_12">
							<nav class="horizontal-nav full-width horizontalNav-notprocessed">
								<ul class="sf-menu">
									...
									<li><a href="customer.jsp">LogOut</a></li>
...
try
{
	...
	ResultSet rs=st.executeQuery("select *from addcab where cspname='"+cspname+ "'");
	...
	<%while(rs.next())
	{
		...
		<td><a href="bookinginfo.jsp?csp=<%=rs.getString(1)%>&&vnumber=<%=rs.getString(5)%>&&vname=<%=rs.getString(4)%>">Book Now</a></td>
		</tr>
		</table>
		<%
		}
