...
try
{
	...
	ResultSet rs=st.executeQuery("select *from cabregister where username='"+uname+"'");
	while(rs.next())
	{
		String csp =rs.getString(1);
	...
	<tr><td>Cab Service Name</td>
	<td><%=csp %></td>
	</tr>
	<tr><td>Starting Date of Service </td>
	<td><%=dos %></td>
	</tr>
