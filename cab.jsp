...
<!--==============================header=================================-->
			...
			<!--==============================Content=================================-->
				...
				<div class="container_12">
					<div class="grid_5">
						<h3>Cab Service Provider Login Form</h3>
						<form name="CustomerloginForm" action="cablogincheck.jsp" method="post">
							...
							<p>Not Yet Registered <a href="cabregister.jsp">Register Here</a></p>
						</form>
					</div>
