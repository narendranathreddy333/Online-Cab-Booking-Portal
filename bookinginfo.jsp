...
<!--==============================header=================================-->
					...
					<div class="container_12">
						<div class="grid_12">
							<nav class="horizontal-nav full-width horizontalNav-notprocessed">
								<ul class="sf-menu">
									<li class="current"><a href="customerhome.jsp">Home</a></li>
			...
			<table align="center">
<form name="search" action="SendbookingRequest.jsp" method="post">
<tr>
<td>Enter PickUp Point</td>
<td>
<input type="text" name="pickup" required></td>
</tr>
<tr>
<td>Enter Destination Point</td>
<td>
<input type="text" name="dest" required></td>
</tr>
<tr><td><input type="submit" value="Search Cab"></td></tr>
</form>
</table>
<%
